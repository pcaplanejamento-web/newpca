 ...
 * usavam ficam sem situação — o aviso diz quantos). A situação NÃO interfere no PCA (o protocolo vai à Mesa
 * do PCA qualquer que seja ela). Só componentes do design-system.
 */
