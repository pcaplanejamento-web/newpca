...
import { IconBox, IconClipboard, IconLayers, IconWallet } from "./icons";

const ICONE: Record<AbaKey, typeof IconClipboard> = { dfd: IconClipboard, pca: IconBox, catalogo: IconLayers, orcamento: IconWallet };
