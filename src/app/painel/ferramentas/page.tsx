...
import { IconChevronRight, IconDashboard, IconLayers, IconUpload } from "@/components/icons";
...
const FERRAMENTAS = [
  ...
  },
  {
    ...
    descricao: "Envie o .xlsx do PCA — os dados alimentam o dashboard.",
    Icon: IconUpload,
...
export default async function FerramentasPage() {
  ...
  const itens = FERRAMENTAS.filter((f) => !f.somenteEditor || podeEditar);
